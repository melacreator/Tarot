...
firstContainer.addEventListener("mouseover", () => {
  firstButtonFirstWay.classList.add("hover-effect");
});
firstContainer.addEventListener("mouseout", () => {
  firstButtonFirstWay.classList.remove("hover-effect");
});

secondContainer.addEventListener("mouseover", () => {
  secondButtonFirstWay.classList.add("hover-effect");
});
secondContainer.addEventListener("mouseout", () => {
  secondButtonFirstWay.classList.remove("hover-effect");
});

thirdContainer.addEventListener("mouseover", () => {
  thirdButtonFirstWay.classList.add("hover-effect");
});
thirdContainer.addEventListener("mouseout", () => {
  thirdButtonFirstWay.classList.remove("hover-effect");
});
fourthContainer.addEventListener("mouseover", () => {
  firstButtonSecondWay.classList.add("hover-effect");
});
fourthContainer.addEventListener("mouseout", () => {
  firstButtonSecondWay.classList.remove("hover-effect");
});

fifthContainer.addEventListener("mouseover", () => {
  secondButtonSecondWay.classList.add("hover-effect");
});
fifthContainer.addEventListener("mouseout", () => {
  secondButtonSecondWay.classList.remove("hover-effect");
});

sixthContainer.addEventListener("mouseover", () => {
  thirdButtonSecondWay.classList.add("hover-effect");
});
sixthContainer.addEventListener("mouseout", () => {
  thirdButtonSecondWay.classList.remove("hover-effect");
});
